...
Python (FastAPI) demo app for Deepgram Flux streaming text-to-speech (v2 Speak).
...
- Async — uses `AsyncDeepgramClient` and iterates `async for message in connection`.
